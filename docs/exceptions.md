...
```typescript
import { NotFoundError, AuthorizationError, ValidationError } from '@stravigor/core/exceptions'
...
```typescript
import { HttpException } from '@stravigor/core/exceptions'
...
```typescript
import { ExternalServiceError } from '@stravigor/core/exceptions'
...
```typescript
import { StravError, HttpException, ConfigurationError } from '@stravigor/core/exceptions'
